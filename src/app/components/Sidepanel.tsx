...
// // API URL
// const apiUrl =
//   "https://api.jup.ag/price/v2?ids=JUPyiwrYJFskUPiHa7hkeR8VUtAeFoSYbKedZNsDvCN," +
...
// export interface SidePanelProps {
//   assets?: Asset[]; // Make assets optional
//   walletAddress?: string;
//   onTrade: (ticker: string) => void;
// }

// const SidePanel = ({ assets = [], walletAddress, onTrade }: SidePanelProps) => {
//   const [coinPrices, setCoinPrices] = useState<{ [key: string]: string }>({});
...
const SidePanel = ({ assets = [], walletAddress, onTrade }: SidePanelProps) => {
  ...
  return (
    ...
    >
      ...
      {/* Display suggested assets regardless of wallet connection */}
      <div>
        <h3
          style={{
            marginBottom: "15px",
